...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      login(res.token, res.data); // Updates context and local storage
    } catch (err) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-black transition-colors duration-200 p-4">
      <div className="max-w-md w-full bg-white dark:bg-gray-900 p-8 rounded-xl shadow-lg border border-gray-200 dark:border-gray-800">
        <div className="text-center mb-8">
          <div className="w-12 h-12 bg-blue-600 rounded mx-auto flex items-center justify-center font-bold text-white mb-4 text-xl">
            TO
          </div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Sign in to TransitOps</h2>
        </div>
