      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-3 text-gray-700 dark:text-gray-300">
          ...
          <div className="flex flex-col">
            <span className="text-sm font-medium text-gray-900 dark:text-white">Alex Manager</span>
            <span className="text-xs text-gray-500 dark:text-gray-400">Fleet Manager</span>
          </div>
        </div>
        
        <button className="text-gray-500 hover:text-red-500 dark:text-gray-400 dark:hover:text-red-400 transition-colors flex items-center gap-2 text-sm font-medium">
          <LogOut size={16} />
          Logout
        </button>
      </div>
